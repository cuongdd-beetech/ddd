         ...
         @endforeach --}}
            ...
            <div class="card-body pt-0 ps-2 pe-2">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="expired_at" placeholder="Enter expired at" name="expired_at" value="{{ old('expired_at') }}" >
                </div>
            ...
            <div class="card-body pt-0 ps-2 pe-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="category_id" placeholder="Enter category id" name="category_id" value="{{ old('category_id') }}" >
                </div>
